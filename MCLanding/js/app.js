(() => {
                    ...
                    if (targetEvent.closest("[data-showmore-button]")) {
                        ...
                        if (!showMoreContent.classList.contains("_slide")) {
                            ...
                            if (showMoreBlock.classList.contains("_showmore-active")) {
                                showMoreButton.querySelector("span:first-child").style.display = "none";
                                showMoreButton.querySelector("span:last-child").style.display = "inline";
                            } else {
                                showMoreButton.querySelector("span:first-child").style.display = "inline";
                                showMoreButton.querySelector("span:last-child").style.display = "none";
                            }
                        }
                    }
    ...
    da.init();
    let countdownDate = (new Date).getTime() + 3 * 24 * 60 * 60 * 1e3;
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const pageTrusted = document.querySelector(".page__trust");
        const menuList = document.querySelector(".trust__menu .menu__list");
